package so.knowledge.corenlp.server;
...
import so.knowledge.corenlp.protocol.*;
import so.knowledge.corenlp.protocol.Process;
...
public class Server extends StanfordCoreNLP {
    ...
    private static void handleMessage(StanfordCoreNLP pipeline,
